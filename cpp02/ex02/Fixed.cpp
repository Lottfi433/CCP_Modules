...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/17 09:20:26 by yazlaigi          #+#    #+#             */
/*   Updated: 2026/01/21 10:01:05 by yazlaigi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed   Fixed::operator/(const Fixed& other) const{
    Fixed result;
    result.setRawBits(((long long)this->_rawBits << _fractionalBits) / other._rawBits);
    return result;
}
